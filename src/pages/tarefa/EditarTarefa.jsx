          ...
          <Grid container spacing={2} mt={1}>
            <Grid item xs={3}>  
              <FormControl>
                ...
                />
                <FormHelperText id="tarefa_inicio_helper_text">Data de inicio</FormHelperText>
              </FormControl>
            </Grid>  
            <Grid item xs={3}>  
              <FormControl>
                ...
                />
                <FormHelperText id="tarefa_fim_helper_text">Data final</FormHelperText>
              </FormControl>
            </Grid>
            <Grid item xs={3}>  
              <FormControl fullWidth>
                <InputLabel htmlFor="tarefa_recurso">Situação</InputLabel>
                <Select
                  id="tarefa_status"
                  value={statusTarefa}
                  label="situacao"
